...
void MdlOutputsVector(NewVectorVar* VecVar) {
	...
	(*VecVar).vectorcontroller.vectorftemp1=fabsf4((*VecVar).vectorcontroller.root_eLXYZ);

	(*VecVar).vectorcontroller.vectorftemp2=nullvector;
	testVec=spu_cmpgt((*VecVar).vectorcontroller.rtP_LXYZ_IntegratorUpperLimit,(*VecVar).vectorcontroller.vectorftemp1);
	...
	testVec1=spu_xor(testVec,testVec1);
	tvec1=spu_convtf((vector unsigned int)testVec1,31);
	tvec1=spu_madd((*VecVar).vectorcontroller.root_eLXYZ,tvec1,nullvector);

	(*VecVar).vectorcontroller.vectorftemp2=nullvector;
	testVec=spu_cmpgt((*VecVar).vectorcontroller.rtP_LXYZ_IntegratorLowerLimit,(*VecVar).vectorcontroller.vectorftemp1);
	testVec1=nullboolvector;
	testVec1=spu_xor(testVec,testVec1);
	(*VecVar).vectorcontroller.vectorftemp1=spu_convtf((vector unsigned int)testVec1,31);
	(*VecVar).vectorcontroller.vectorftemp1=spu_madd((*VecVar).vectorcontroller.vectorftemp1,(*VecVar).vectorcontroller.root_eLXYZ,nullvector);
	tvec1=spu_madd((*VecVar).vectorcontroller.vectorftemp1,(*VecVar).vectorcontroller.rtP_LXYZ_GainKn,tvec1);

	(*VecVar).vectorcontroller.vectorftemp2
			=spu_madd((*VecVar).vectorcontroller.rtP_LXYZ_IntegratorLowerLimit,negationvector,(*VecVar).vectorcontroller.rtP_LXYZ_IntegratorUpperLimit);

	(*VecVar).vectorcontroller.vectorftemp1
			=spu_madd((*VecVar).vectorcontroller.rtP_LXYZ_GainKn,(*VecVar).vectorcontroller.rtP_LXYZ_IntegratorLowerLimit,nullvector);
	(*VecVar).vectorcontroller.vectorftemp1
			=spu_madd(negationvector,(*VecVar).vectorcontroller.rtP_LXYZ_IntegratorUpperLimit,nullvector);
	...
	tvec2=spu_madd((*VecVar).vectorcontroller.vectorftemp1,(*VecVar).vectorcontroller.rtP_LXYZ_IntegratorLowerLimit,(*VecVar).vectorcontroller.rtP_LXYZ_IntegratorLowerLimit);
	//tvec2=ftemp2


	testVec1=spu_cmpgt(nullvector,(*VecVar).vectorcontroller.root_eLXYZ);
	(*VecVar).vectorcontroller.vectorftemp2=spu_convtf((vector unsigned int)testVec1,31);
	(*VecVar).vectorcontroller.vectorftemp2
			=spu_madd((*VecVar).vectorcontroller.vectorftemp2,negationvector,nullvector);
	(*VecVar).vectorcontroller.vectorftemp2=spu_madd((*VecVar).vectorcontroller.vectorftemp2,(*VecVar).vectorcontroller.vectorftemp2,nullvector);

	(*VecVar).vectorcontroller.vectorftemp1
			=spu_madd((*VecVar).vectorcontroller.vectorftemp1,negationvector,nullvector);

	(*VecVar).vectorcontroller.vectorftemp1=spu_add((*VecVar).vectorcontroller.vectorftemp1,(*VecVar).vectorcontroller.root_eLXYZ);
	(*VecVar).vectorcontroller.vectorftemp1=spu_add((*VecVar).vectorcontroller.vectorftemp1,(*VecVar).vectorcontroller.vectorftemp2);

	(*VecVar).vectorcontroller.vectorftemp1=spu_convtf((vector unsigned int)testVec,31);
	(*VecVar).vectorcontroller.vectorftemp1=spu_madd((*VecVar).vectorcontroller.vectorftemp2,(*VecVar).vectorcontroller.vectorftemp1,nullvector);

	(*VecVar).vectorcontroller.vectorftemp1=spu_add((*VecVar).vectorcontroller.vectorftemp1,tvec1);

	/// uncomment for calc without gainadaption
	//(*VecVar).vectorcontroller.vectorftemp1=(*VecVar).vectorcontroller.root_eLXYZ;


	(*VecVar).vectorcontroller.vectorftemp1=spu_madd((*VecVar).vectorcontroller.vectorftemp1,(*VecVar).vectorcontroller.vectorcycletime,(*VecVar).vectorcontroller.rtB_IntegratorSumLXYZ);
	...
	testVec=spu_cmpgt((*VecVar).vectorcontroller.vectorftemp1,(*VecVar).vectorcontroller.rtP_LXYZ_IntegratorUpperLimit);
	(*VecVar).vectorcontroller.vectorftemp1=spu_convtf((vector unsigned int)testVec,31);
	(*VecVar).vectorcontroller.vectorftemp2
			=spu_madd((*VecVar).vectorcontroller.vectorftemp1,(*VecVar).vectorcontroller.rtP_LXYZ_IntegratorUpperLimit,nullvector);

	testVec=spu_cmpgt((*VecVar).vectorcontroller.vectorftemp1,(*VecVar).vectorcontroller.rtP_LXYZ_IntegratorLowerLimit);
	(*VecVar).vectorcontroller.vectorftemp1=spu_convtf((vector unsigned int)testVec,31);
	...
	(*VecVar).vectorcontroller.vectorftemp2=spu_convtf((vector unsigned int)testVec,31);
	(*VecVar).vectorcontroller.vectorftemp1
			=spu_madd((*VecVar).vectorcontroller.vectorftemp2,(*VecVar).vectorcontroller.rtP_LXYZ_IntegratorLowerLimit,nullvector);

	(*VecVar).vectorcontroller.vectorftemp1=spu_madd((*VecVar).vectorcontroller.vectorftemp1,(*VecVar).vectorcontroller.rtP_LXYZ_GainKn,nullvector);

	(*VecVar).vectorcontroller.vectorftemp2=spu_sub((*VecVar).vectorcontroller.root_eLXYZ,(*VecVar).vectorcontroller.rtB_OldDeviationLXYZ);
	(*VecVar).vectorcontroller.vectorftemp2=spu_madd((*VecVar).vectorcontroller.vectorftemp2,(*VecVar).vectorcontroller.rtP_LXYZ_GainKv,nullvector);
	(*VecVar).vectorcontroller.vectorftemp2
			=spu_madd((*VecVar).vectorcontroller.vectorftemp2,vectorcycletimediv,nullvector);

	(*VecVar).vectorcontroller.rtB_OldDeviationLXYZ=(*VecVar).vectorcontroller.root_eLXYZ;

	(*VecVar).vectorcontroller.vectorftemp2=spu_add((*VecVar).vectorcontroller.vectorftemp1,(*VecVar).vectorcontroller.vectorftemp2);//I+D
	(*VecVar).vectorcontroller.rtY_root_yLXYZ=spu_madd((*VecVar).vectorcontroller.rtP_LXYZ_GainKp,(*VecVar).vectorcontroller.root_eLXYZ,(*VecVar).vectorcontroller.vectorftemp2);

	(*VecVar).vectorcontroller.rtB_IntegratorSumLXYZ=spu_madd((*VecVar).vectorcontroller.rtB_IntegratorSumLXYZ,(*VecVar).vectorcontroller.rtP_LXYZ,nullvector);
	(*VecVar).vectorcontroller.rtY_root_yLXYZ=spu_madd((*VecVar).vectorcontroller.rtY_root_yLXYZ,(*VecVar).vectorcontroller.rtP_LXYZ,nullvector);
	(*VecVar).vectorcontroller.rtB_OldDeviationLXYZ=spu_madd((*VecVar).vectorcontroller.rtB_OldDeviationLXYZ,(*VecVar).vectorcontroller.rtP_LXYZ,nullvector);
	/// 55 VectorOperations
